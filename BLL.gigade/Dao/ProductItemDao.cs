...
namespace BLL.gigade.Dao
{
    public class ProductItemDao : IProductItemImplDao
    {
        ...
        public DataTable GetSuggestPurchaseInfo(ProductItemQuery query, out int TotalCount)
        {
            ...
            sbSqlTable.AppendFormat(" left join order_detail dt1 on dt1.slave_id=os.slave_id and dt1.detail_status=4 where FROM_UNIXTIME( om.order_createdate)>='{0}' and od.item_mode in (0,2) and od.detail_status=4 GROUP BY od.item_id) sum_biao ", sumdate);
