...
namespace BLL.gigade.Model
{
    public class Schedule
    {
        ...
        public int type { get; set; }//1:單次執行,2:多次執行
        ...
        public int date_value { get; set; } //2D:該值為null,2W:該值為0~4:2M:該值為1~31
        public int repeat_count { get; set; }//重複的次數
        public int repeat_hours { get; set; } //重複的小時數
        public int time_type { get; set; } //時間單位(用於repeat_hours的後綴) 1:H(時) 2:M(分):3:S(秒)
        public string week_day { get; set; } // 星期
        public DateTime start_time { get; set; }//執行時間精確到second 
        public DateTime end_time { get; set; }//重複小時結束時間
