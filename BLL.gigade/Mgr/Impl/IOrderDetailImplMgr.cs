 ...
 * All rights reserved. 
 *  
 * 文件名称：IOrderDetailImplMgr 
 * 摘   要： 
 *  
 * 当前版本：1.0 
 * 作   者：lhInc 
 * 完成日期：2013/8/22 17:02:29 
 * 
 */
...
{
    public interface IOrderDetailImplMgr
    {
        ...
        List<OrderDetailCustom> GetArriveDay(uint detail_id);//add by wwei0216w 獲得商品的運達天數
