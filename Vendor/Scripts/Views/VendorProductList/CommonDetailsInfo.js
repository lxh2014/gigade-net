...
function createForm(product_id) {
    ...
    //判斷商品類型 (單一商品 OR 組合商品)
    Ext.Ajax.request({
        url: '/VendorProductList/ProductDetailsQuery',
        method: 'post',
        async: false,
        params: {
    ...
    var baseInfo = Ext.create('Ext.form.Panel', {
        ...
        listeners: {
            beforerender: function () {
                ToolAuthorityQueryByUrl("/VendorProductList/ProductDetails", function () { setShow(baseInfo, 'colName'); });
                Page_Load("baseInfo");
            }
        }
    });
    ...
    var description = Ext.create('Ext.form.Panel', {
        ...
        listeners: {
            beforeactivate: function () {
                //加載標籤
                Ext.Ajax.request({
                    url: '/VendorProductList/GetProTag',
                    method: 'post',
                    params: {
                        ProductId: product_id
                    },
                ...
                //加載公告
                Ext.Ajax.request({
                    url: '/VendorProductList/GetProNotice',
                    method: 'post',
                    params: {
                        ProductId: product_id
                    },
