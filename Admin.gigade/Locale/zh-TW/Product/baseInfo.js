Ext.onReady(function () {
    ...
    //add by Jiajun 2014/09/15
    SHOE_IN_DELIVER = "顯示於出貨單中";
    PREPAID = "已買斷的商品";
    PROCESS_TYPE = "配送系統";
    PRODUCT_TYPE = "商品型態";
    PRO_TYPE_WL = "物流配送";
    ...
    PRO_TYPE_JX = "簡訊";
    PRO_TYPE_XT = "系統";
    PRODUCT_TYPE_NOT_NULL = "商品型態不能為空";
    //add by Jiajun 2014.09.29
    BAG_CHECK_PREPAID = " 請至ERP系統修改該品號的「商品類別」";
    ...
    PLEASE_WRITE_SHIPMENT_MESSAGE = "請填寫預計出貨信息.";
