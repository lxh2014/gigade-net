            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        ...
                        dr[4] = list[i].product_status_string;
                        dr[5] = list[i].process_type_string;
                        dr[6] = list[i].product_freight_set_string;
                        dr[7] = list[i].product_createdate_string;
                        dr[8] = list[i].product_start_string;
                        dtHZ.Rows.Add(dr);
                    }
