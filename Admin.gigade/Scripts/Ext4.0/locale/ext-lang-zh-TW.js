...
Ext.onReady(function(){
    ...
    if (Ext.Date || Ext.picker.DateTime){
        Ext.Date.monthNames = [
        "一月",
        "二月",
        "三月",
    ...
    if(Ext.picker.DateTime){
        Ext.apply(Ext.picker.DateTime.prototype, {
            todayText         : "今天",
            minText           : "日期必須大於最小容許日期",
            maxText           : "日期必須小於最大容許日期",
            disabledDaysText  : "",
    ...
    if(Ext.form.field.DateTime){
        Ext.apply(Ext.form.field.DateTime.prototype, {
            disabledDaysText  : "無法使用",
            disabledDatesText : "無法使用",
            minText           : "此欄位之日期必須在 {0} 之後",
            maxText           : "此欄位之日期必須在 {0} 之前",
