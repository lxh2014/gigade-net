    ...
    var ExportFrm = Ext.create('Ext.form.Panel', {
        ...
        items: [
            ...
            },
            {
             ...
             {
                    html: '<ol><li>CSV檔案，一列一筆資料，若資料有異常，系統主動略過不處理。</li><li><li>欄位一：電子信箱位址。</li><li>欄位二：是否訂閱電子報，0（不訂閱），1（訂閱）。若不為 0、1、未指定或有錯誤時，預設皆為訂閱。</li><li>欄位三：信箱名稱，即收信人名稱，或無指定，預設以電子信箱帳號代替。</li><li>其它欄位：皆略過不處理。</li></li><li>若此郵件群組中已有相同信箱時，系統不重覆匯入，但欄位二、欄位三資訊，會以匯入檔案資訊取代。</li></ol>'
