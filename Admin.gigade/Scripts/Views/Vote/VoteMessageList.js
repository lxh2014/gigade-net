...
function Query(x) {
    if (Ext.getCmp('message').getValue().trim() != "" || Ext.getCmp('vote_status').getValue() != -1 || Ext.getCmp('Article').getValue() != 0) {
                    ...
                    },
                    {
                        ...
                        listeners: {
                            click: function () {
                                ...
                                Ext.getCmp('message').setValue("");//開始時間--time_start--delivery_date
