...
//到Controller獲取數據
var WCT3Store = Ext.create('Ext.data.Store', {
    autoDestroy: true, //自動消除
    pageSize: pageSize,
    model: 'gigade.WCT3',
    proxy: {
        type: 'ajax',
        url: '/WebContentType/WebContentTypelist3',
        reader: {
            type: 'json',
            root: 'data',
...
WCT3Store.on('beforeload', function () {
    Ext.apply(WCT3Store.proxy.extraParams, {
...
Ext.onReady(function () {
    var gdFgroup = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { header: SITEID, dataIndex: 'site_name', width: 110, align: 'center' },
            { header: PAGEID, dataIndex: 'page_name', width: 110, align: 'center' },
            { header: AREAID, dataIndex: 'area_name', width: 110, align: 'center' },
//            { header: "Brand_id", hidden: true, dataIndex: 'brand_id', width: 110, align: 'center' },
            { header: BRANDID, hidden: false, dataIndex: 'brand_name', width: 120, align: 'center' },
            { header: TYPRID, dataIndex: 'type_id', width: 110, align: 'center', hidden: true },
    ...
    ToolAuthority();
    WCT3Store.load({ params: { start: 0, limit: pageSize} });
});

/********************************************新增*****************************************/
onAddClick = function () {
    editFunction(null, WCT3Store);
}
