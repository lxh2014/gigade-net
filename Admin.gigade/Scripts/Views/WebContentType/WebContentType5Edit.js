editFunction = function (Row, store) {
    ...
    var editFrm = Ext.create('Ext.form.Panel', {
        ...
        autoScroll: true,
        labelWidth: 45,
        url: '/WebContentType/SaveWebContentType5',
                ...
                },
                {
                    ...
                    listeners: {
                        beforequery: function (qe) {
                            ...
                            //                                        {
                            //                                            type: 'area',
                            //                                            pageid: Ext.getCmp('page_id')== null ? 0 : Ext.getCmp('page_id').getValue(),
                            //                                            webcontenttype_page: 'web_content_type5'
                            //                                        });
                            //                            });
                            areaidStore.load();
                        },
