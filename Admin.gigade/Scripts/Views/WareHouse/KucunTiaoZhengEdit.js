function addFunction(row, store, vendorid) {
    var cde_dt_shp;
    var pwy_dte_ctl;
    var cde_dt_var;
    var cde_dt_incr;
    ...
    var editFrm = Ext.create('Ext.form.Panel', {
        ...
        items: [
                   {
                       ...
                       allowBlank:false,
                       allowBlank: false,
                       value: Ext.getCmp('item_id').getValue(),
                       listeners: {
        ...
        buttons: [{
            ...
            handler: function () {
                ...
                if (isloc == 6) {//表示驗證成功
                    //vendor_id = store.data.items[0].raw.vendor_id;
                    vendor_id = vendorid;
                    if (form.isValid()) {
                        ...
                        Ext.Ajax.request({
                            ...
                            failure: function (form, action) {
                                ...
                                Ext.Msg.alert(INFORMATION, "等待超時!");
                            }
                        });
                        //$.get('/WareHouse/GetSearchStock',
                        //    {
                        //        'loc_id': Ext.getCmp("plas_loc_id").getValue(),
                        //        'item_id': Ext.getCmp("plas_prod_id").getValue(),
                        //        cde_date: Ext.getCmp('cde_dt').getValue(),
                    ...
                    Ext.MessageBox.alert(INFORMATION, "上架料位被其他商品占用！");
                } else if (isloc == 3) {
