            ...
            handler: function () {
                ...
                if (form.isValid()) {
                    ...
                    Ext.Ajax.request({
                        ...
                        method: 'post',
                        params: { rowid: promoID, fixed_price: Ext.htmlEncode(Ext.getCmp('fixed_price1').getValue()), producateid: produCateID, websiteid: websiteID, types: 1 },
                        success: function (form, action) {
                            var result = Ext.decode(form.responseText);
                            if (result.success) {
                                ...
                                Ext.Ajax.request({
                                    ...
                                    params: {
                                        ...
                                        start_date: Ext.Date.format(new Date(Ext.getCmp('start_date').getValue()), 'Y-m-d H:i:s'),//Ext.htmlEncode(Ext.getCmp('start_date').getValue()),
                                        end_date: Ext.Date.format(new Date(Ext.getCmp('end_date').getValue()), 'Y-m-d H:i:s'), //Ext.htmlEncode(Ext.getCmp('end_date').getValue()),
    ...
    var UpdFrm = Ext.widget('form', {
        ...
        buttons: [{
            ...
            handler: function () {
                ...
                //if ((condition_id == "" || condition_id == "0") && (Ext.getCmp("groupname").getValue() == null || Ext.getCmp("groupname").getValue() == "")) {
                //    Ext.Msg.alert(INFORMATION, USERCONDITIONERROR);
                //    return;
                //}
                if (form.isValid()) {
                    ...
                    Ext.Ajax.request({
                        url: '/PromoAdditionalPrice/DeletLessThen',
                        method: 'post',
                        params: { rowid: promoID, fixed_price: Ext.htmlEncode(Ext.getCmp('fixed_price').getValue()), producateid: produCateID, websiteid: websiteID, types: 1 },
                        success: function (form, action) {
                            var result = Ext.decode(form.responseText);
                            if (result.success) {
    ...
    var Updwin = Ext.create('Ext.window.Window', {
        ...
        listeners: {
            'show': function () {
                ...
                //var store = combobox.store.loadRecord;
