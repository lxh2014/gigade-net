...
var FaresStore = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type: 'ajax',
        url: '/PromotionsBonus/PromotionsBonusSerialHistoryLists',
        reader: {
            type: 'json',
            root: 'items'
...
Ext.onReady(function () {
    ...
    var gdFgroup = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            { header: XVHAO, dataIndex: 'serial', flex: 1, align: 'center', align: 'center' },
            {
                header: "兌換人員", dataIndex: 'user_email', flex: 2, align: 'center',
            ...
            { header: '兌換時間', dataIndex: 'created', flex: 2, align: 'center' }
        ],
        tbar: [
            {
                xtype: 'label',
