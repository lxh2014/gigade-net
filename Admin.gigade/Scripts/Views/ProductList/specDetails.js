...
function createContentPanel(typeVal) {
    ...
    spec1Grid = Ext.create('Ext.grid.Panel', {
        ...
        height: 300,
        columns: [
        { id: 'spec1_name', colName: 'spec_name', hidden: true, menuDisabled: true, width: 150, header: SPEC_CONTENT, dataIndex: 'spec_name' },
        { id: 'spec1_sort', colName: 'spec_sort', hidden: true, menuDisabled: true, width: 100, header: SPEC_SORT, dataIndex: 'spec_sort' },
        { id: 'spec1_status', colName: 'spec_status', hidden: true, menuDisabled: true, width: 100, header: SPEC_SHOW, dataIndex: 'spec_status', renderer: statusRenderer1 },
    ...
    spec2Grid = Ext.create('Ext.grid.Panel', {
        ...
        height: 300,
        columns: [
        { id: 'spec2_name', colName: 'spec_name', hidden: true, menuDisabled: true, width: 150, header: SPEC_CONTENT, dataIndex: 'spec_name' },
        { id: 'spec2_sort', colName: 'spec_sort', hidden: true, menuDisabled: true, width: 100, header: SPEC_SORT, dataIndex: 'spec_sort' },
         { id: 'spec2_status', colName: 'spec_status', hidden: true, menuDisabled: true, width: 100, header: SPEC_SHOW, dataIndex: 'spec_status', renderer: statusRenderer2 },
