Ext.onReady(function () {
    ...
    var EdmSendListCountGrid = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
                {
                    header: "log_id", dataIndex: 'log_id', width: 80, align: 'center'
                },
                {
                    header: "content_id", dataIndex: 'content_id', width: 80, align: 'center'
                },
 
                {
                    header: "emai_id", dataIndex: 'emai_id', width: 80, align: 'center'
                },
                {
                    header: "first_traceback", dataIndex: 'first_traceback', width: 80, align: 'center'
                },
                                {
                                    header: "last_traceback", dataIndex: 'last_traceback', width: 80, align: 'center'
                                },
                  {
                      header: "count", dataIndex: 'count', width: 80, align: 'center'
                  },
                     {
                         header: "success", dataIndex: 'success', width: 80, align: 'center'
                     },
                        {
                            header: "email", dataIndex: 'email', width: 80, align: 'center'
                        },
                          {
                              header: "name", dataIndex: 'name', width: 80, align: 'center'
                          },
                ],
