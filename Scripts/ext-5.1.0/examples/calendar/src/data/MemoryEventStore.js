        ...
        if (me.data && me.data.length > 0) {
            ...
            if (records.length > 0) {
                for (var i = 0; i < records.length;i++){
                    records[i].data.StartDate = new Date(parseInt((records[i].data.StartDateStr * 1000)))
                    records[i].data.EndDate = new Date(parseInt((records[i].data.EndDateStr*1000)));
                }
            }
