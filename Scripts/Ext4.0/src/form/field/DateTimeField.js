...
Ext.define('Ext.form.field.DateTime', {
    ...
    */
    ...
    //add by zhuoqin0830w  2015/03/16  定義變量  時間數組
    time: { hour: new Date().getHours(), min: new Date().getMinutes(), sec: new Date().getSeconds() },
    ...
    */
    onExpand: function () {
        ...
        //edit by zhuoqin0830w  2015/03/16  接收時間數組的值
        me.picker.hour.setDisabled(me.disabledHor);
        //me.picker.hour.setValue(!me.disabledHor ? new Date().getHours() : 0);
        me.picker.hour.setValue(!me.disabledHor ? me.time.hour : 0);

        me.picker.minute.setDisabled(me.disabledMin);
        //me.picker.minute.setValue(!me.disabledMin ? new Date().getMinutes() : 0);
        me.picker.minute.setValue(!me.disabledMin ? me.time.min : 0);

        me.picker.second.setDisabled(me.disabledSec);
        //me.picker.second.setValue(!me.disabledSec ? new Date().getSeconds() : 0);
        me.picker.second.setValue(!me.disabledSec ? me.time.sec : 0);
    },
