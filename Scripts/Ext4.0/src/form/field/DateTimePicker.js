...
Ext.define('Ext.picker.DateTime', {
    ...
    */
    selectToday: function () {
        ...
        var now = new Date(),
            now_str = Ext.Date.format(now, "Y/m/d")
        + ' ' + (me.hour.isDisabled() ? '00' : now.getHours())
        + ':' + (me.minute.isDisabled() ? '00' : now.getMinutes())
        + ':' + (me.second.isDisabled() ? '00' : now.getSeconds());
        me.setValue(new Date(now_str));
