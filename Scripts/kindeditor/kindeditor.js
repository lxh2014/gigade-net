...
(function (KE, undefined) {
    ...
    KE.lang = {
        ...
        invalidWidth: "高度必須為數字。",
        invalidHeight: "高度必須為數字。",
        invalidBorder: "邊框必須為數字。",
        invalidUrl: "请输入有效的URL地址。",
        invalidRows: '行數為必選項，只允許輸入大於0的數字。',
        invalidCols: '列數未必選項，只允許輸入大於0的數字。',
        invalidPadding: '邊距必須為數字。',
        invalidSpacing: '間隔必須為數字。',
        invalidBorder: '邊框必須為數字。',
        pleaseInput: "請輸入類容。",
        invalidJson: '服務器發生故障。',
        cutError: '您的瀏覽器安全設置不允許使用剪切操作，請使用快捷鍵(Ctrl+X)來完成。',
        copyError: '您的瀏覽器安全設置不允許使用複製操作，請使用快捷鍵(Ctrl+C)来完成。',
        pasteError: '您的瀏覽器安全設置不允許使用粘貼操作，請使用快捷鍵(Ctrl+V)来完成。'
    };
    ...
    plugins.plainpaste = {
        comment: '請使用快捷鍵(Ctrl+V)把內容粘貼到下面的方框中。'
    };
