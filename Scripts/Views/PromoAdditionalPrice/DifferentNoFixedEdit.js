                ...
                //}
                    ...
                    form.submit({
                        params: {
                            ...
                            discount: Ext.htmlEncode(Ext.getCmp('discount1').getValue())//add 20140925 jialei 折扣
                        },
                        success: function (form, action) {
                ...
                listeners: {
                    change: function (field, newValue, oldValue) {
                        ...
                        if (newValue !== oldValue) {//网上银行    
                            Ext.getCmp('discount1').getEl().first().dom.innerHTML = '商品折扣' + ":<font style='color:red'>" + newValue + "%</font>";
        ...
        //            },
            ...
            },
            {
                ...
                listeners: {
                    change: function (field, newValue, oldValue) {
                        if (newValue !== oldValue) {//网上银行    
                            Ext.getCmp('discount').getEl().first().dom.innerHTML = '商品折扣' + ":<font style='color:red'>" +  newValue + "%</font>";
                            //label = Ext.getCmp('no_discount').getEl().parent().parent().first();
                            //  label.dom.innerHTML = DISCOUNT+(100-newValue)+"%";
                            //Ext.DomQuery.selectNode('label[for=no_discount]').innerHTML =DISCOUNT+(100-newValue)+ '%';
                        }
    ...
    var Updwin = Ext.create('Ext.window.Window', {
        ...
        listeners: {
            'show': function () {
                ...
                //        Ext.getCmp('groupname').setValue(BUFEN);
                //    }
                //    else {
