...
var FaresStore = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type: 'ajax',
        url: '/PromoAdditionalPrice/PromoAdditionalPriceList?event_type=A2',
        reader: {
            type: 'json',
            root: 'data',
...
Ext.onReady(function () {
    var gdFgroup = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {
                header: VIPGROUP, dataIndex: 'group_name', width: 120, align: 'center', renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
            ...
            { header: "WebSite", dataIndex: 'website', width: 130, align: 'center', hidden: true },
