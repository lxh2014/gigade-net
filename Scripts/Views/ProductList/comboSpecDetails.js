...
function createComboOptional(product_id) {
    ...
    var optionalGrid = Ext.create('Ext.grid.Panel', {
        ...
        height: 200,
        width: 400,
        columns: [{ header: PRODUCT_NUM, colName: 'productNum', hidden: true, menuDisabled: true, sortable: false, dataIndex: 'Child_Id' },
             { header: PRODUCT_NAME, colName: 'product_name', hidden: true, menuDisabled: true, sortable: false, width: 200, dataIndex: 'Product_Name', flex: 1 },
             { header: UNIT_NUM, menuDisabled: true, colName: 'unitNum', hidden: true, sortable: false, width: 100, dataIndex: 'S_Must_Buy' },
             { header: 'rid', hidden: true, dataIndex: 'Id'}]
    });
...
function createComboGroup(product_id) {
    ...
    function createGridPanel(index, value, pileId) {
        ...
        var grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [{ header: PRODUCT_NUM, colName: 'productNum', hidden: true, menuDisabled: true, sortable: false, dataIndex: 'Child_Id' },
             { header: PRODUCT_NAME, colName: 'product_name', hidden: true, menuDisabled: true, sortable: false, width: 200, dataIndex: 'Product_Name', flex: 1 },
             { header: UNIT_NUM, colName: 'unitNum', hidden: true, menuDisabled: true, sortable: false, width: 100, dataIndex: 'S_Must_Buy' },
             { header: 'rid', hidden: true, dataIndex: 'id'}]
        });
