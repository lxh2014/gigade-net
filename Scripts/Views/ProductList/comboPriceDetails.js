...
function createPricePanel(combination, product_id, price_type) {
    ...
    firPanel = Ext.create("Ext.form.Panel", {
        ...
        items: [{
            ...
            items: [
            {
                ...
                hidden: true,
                xtype: 'displayfield',
                value: '<span style="color:red">' + PRICE_COST_MESSAGE_TEXT + '</span>'
            }]
        }, {
            xtype: 'gridpanel',
            id: 'siteProdutctGrid',
            ...
            height: 150,
            columns: [
                { colName: 'site_name', hidden: true, header: SITENAME, dataIndex: 'site_name', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'product_name', hidden: true, header: PRODUCTNAME, dataIndex: 'product_name', width: 180, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'user_level', hidden: true, header: USERLEVEL, dataIndex: 'user_level', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'user_email', hidden: true, header: USERMAIL, dataIndex: 'user_email', width: 120, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'price_status', header: PRICESTATUS, dataIndex: 'status', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
                //edit by hjj 2014/08/13 將固定組合商品與單一商品售價與成本的順序一致化
                { colName: 'price', hidden: true, header: PRICE, dataIndex: 'price', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'item_cost', hidden: true, header: COST, dataIndex: 'cost', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'default_bonus_percent', hidden: true, header: DEFAULTBONUSPERCENT, dataIndex: 'default_bonus_percent', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'event_price', hidden: true, header: EVENTPRICE, dataIndex: 'event_price', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'event_item_cost', hidden: true, header: EVENT_COST, dataIndex: 'event_cost', width: 100, align: 'center', sortable: false, menuDisabled: true },
                { colName: 'event_time', hidden: true, header: EVENT_TIME, xtype: 'templatecolumn',
                ...
                { colName: 'bonus_percent', hidden: true, header: BONUSPERCENT, dataIndex: 'bonus_percent', width: 100, align: 'center', sortable: false, menuDisabled: true },
    ...
    if (combination == 2 || combination == 3) {
        ...
        if (price_type == 1) {
            ...
            combinationStore.load({ params: { product_id: product_id, pile_id: 0, Price_type: price_type } });
        }
        else {
            combinationStore = Ext.create("Ext.data.Store", {
            ...
            success: function (response) {
                ...
                for (var i = 1; i <= pileCount; i++) {
                    ...
                    if (price_type == 1) {
                        ...
                        priceStore.load({ params: { product_id: product_id, pile_id: resText[i - 1].Pile_Id, Price_type: price_type } });
                    }
                    else {
                        priceStore = Ext.create("Ext.data.Store", {
                            model: 'GIGADE.CHILDPRODUCT'
...
function singlePricePanel(product_id) {
    ...
    var siteProdutctGrid = Ext.create('Ext.grid.Panel', {
        ...
        height: 150,
        columns: [
            { colName: 'site_name', header: SITENAME, dataIndex: 'site_name', width: 130, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'product_name', header: PRODUCTSHOENAME, dataIndex: 'product_name', width: 180, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'user_level', header: USERLEVEL, dataIndex: 'user_level_name', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'user_email', header: USERMAIL, dataIndex: 'user_email', width: 120, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'price_status', header: PRICESTATUS, dataIndex: 'status', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'price', header: ITEM_MONEY, dataIndex: 'item_money', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            ...
            { colName: 'default_bonus_percent', header: DEFAULTBONUSPERCENT, dataIndex: 'default_bonus_percent', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'event_price', header: ITEM_EVENT_MONEY, dataIndex: 'event_money', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            ...
            { colName: 'bonus_percent', header: BONUSPERCENT, dataIndex: 'bonus_percent', width: 100, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'bonus_percent_start', header: BONUS_PERCENT_TIME, xtype: 'templatecolumn',
                tpl: Ext.create('Ext.XTemplate',
                    '{[values.bonus_percent_start==0?"":Ext.Date.format(new Date(values.bonus_percent_start * 1000),"Y/m/d H:i:s")]}',
                    '~',
    ...
    var gigadeGrid = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            { colName: 'item_id', header: ITEM_ID, dataIndex: 'Item_Id', width: 80, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'txtSpec1Name', header: ITEM_SPEC1, dataIndex: 'Spec_Name_1', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'txtSpec2Name', header: ITEM_SPEC2, dataIndex: 'Spec_Name_2', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'product_vendor_code', header: ITEM_CODE, dataIndex: 'Item_Code', width: 160, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'price', header: ITEM_MONEY, dataIndex: 'Item_Money', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'item_cost', header: ITEM_COST, dataIndex: 'Item_Cost', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'event_price', header: ITEM_EVENT_MONEY, dataIndex: 'Event_Item_Money', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true },
            { colName: 'event_item_cost', header: ITEM_EVENT_COST, dataIndex: 'Event_Item_Cost', width: 110, align: 'center', sortable: false, menuDisabled: true, hidden: true }
        ]
    });
