...
function initProductStatusPanel(product_id, product_status, create_channel) {
    ...
    historyStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '/ProductList/ProductStatusHistoryQuery',
            actionMethods: 'post',
            reader: {
                type: 'json',
                root: 'data'
    ...
    productStatusPanel.store.load({
        params: { ProductId: product_id, Create_Channel: create_channel },
