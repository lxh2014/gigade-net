...
Ext.onReady(function () {
    var gdFgroup = Ext.create('Ext.grid.Panel', {
        ...
        frame: true,
        columns: [
            { header: 'ID', dataIndex: 'rowid', align: 'center', hidden: true },
            { header: GROUPNAME, dataIndex: 'groupName', width: 150, align: 'center' },
            { header: GROUPCODE, dataIndex: 'groupCode', width: 150, align: 'center' },
            { header: CALLID, dataIndex: 'callid', align: '120', align: 'center' },
            { header: REMARK, dataIndex: 'remark', align: '120', align: 'center'}],
        tbar: [
