...
Ext.onReady(function () {
                      ...
                      },
                      {
                          ...
                          listeners: {
                              click: function () {
                                  ...
                                  Ext.getCmp('ddlSel').setValue("0");//狀態
    ...
    var TicketDetail = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {
                header: "供應商", dataIndex: 'vendor_name_simple', width: 150, align: 'center', id: 'vendor_id', hidden: true},
            {
        ...
        tbar: [
          { xtype: 'button', text: "核銷", id: 'UpdateStatus', hidden: true, disabled: true, iconCls: 'ui-icon ui-icon-dis', handler: UpdateDetailsClick },//iconCls: 'icon-remove',
        ],
